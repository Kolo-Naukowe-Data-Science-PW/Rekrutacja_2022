def dijkstra(graph, start, end):
    ...
    # make reverse paths for undirected graphs
    for (u, v), w in graph_copy.items():
        graph[v, u] = w
    ...
    while end not in visited:
        ...
        for value, node in available_paths[current_node]:
            ...
            # prevent going in circles in undirected graphs
            if current_node in available_paths[node]:
                available_paths[node].remove(current_node)
